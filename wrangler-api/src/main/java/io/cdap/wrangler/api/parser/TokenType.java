...
public enum TokenType implements Serializable {
  ...
  /**
   * Represents the enumerated type for tokens that define byte sizes,
   * such as "10KB", "2MB". This type is associated with the
   * {@code ByteSize} token and is used to parse and interpret data size values.
   */
  BYTE_SIZE,
